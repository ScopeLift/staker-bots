...
export const RARI_CONSTANTS = {
  ...
  STAKER_CONTRACT_ADDRESS:
    ...
    '0x8B7610ef891d40745d70e6b9C8Ae92DfF7a01B7a',
  EARNING_POWER_CALCULATOR_ADDRESS:
    process.env.EARNING_POWER_CALCULATOR_ADDRESS ||
    '0xD7213a45bE3fAd1B0715412BDAaAdf1EadD554d1',
  RARI_TOKEN_ADDRESS:
    process.env.RARI_TOKEN_ADDRESS ||
    '0xBcBA0785b51ad5305E5c19471eeE9e87f6d6D976',
  REWARD_NOTIFIER_ADDRESS:
    process.env.REWARD_NOTIFIER_ADDRESS ||
    '0xDA5b7BCcFF23eEdceB7C963CA1972F1EEe5fbe0B',
  AUTO_DELEGATE_ADDRESS:
    process.env.AUTO_DELEGATE_ADDRESS ||
    '0x63B7806b32d7cff30a680D869E1FA372cd05B764',
  RSTRARI_ADDRESS:
  ...
  REWARD_RATE_PER_BLOCK:
    process.env.REWARD_RATE_PER_BLOCK || '1000000000000000', // 0.001 ETH in wei
  EXPECTED_BLOCKS_BEFORE_NEXT_BUMP:
    process.env.EXPECTED_BLOCKS_BEFORE_NEXT_BUMP || '40320', // ~1 week at 15s blocks

  // Claim and Distribute Bot Configuration
  CLAIM_GAS_LIMIT: process.env.CLAIM_GAS_LIMIT || '500000',
  CLAIM_PROFIT_THRESHOLD:
    process.env.CLAIM_PROFIT_THRESHOLD || '1000000000000000', // 0.001 ETH in wei
};
